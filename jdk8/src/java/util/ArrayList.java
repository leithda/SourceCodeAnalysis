...
/**
 * 允许元素为null，会自动扩容
 * size,isEmpty,get,set,add等方法时间复杂度为O(1)
 * 非线程安全，多线程推荐使用： #Collections#synchronizedList
 * 支持fast-fail机制，避免迭代过程中元素被修改
 * @since   1.2
 */
        ...
        implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
    ...
    private void grow(int minCapacity) {
        ...
        if (newCapacity - MAX_ARRAY_SIZE > 0)
            newCapacity = hugeCapacity(minCapacity);    // 大容量处理
    ...
    /**
     * 判断集合是否包含给定元素，为空使用==判断，非空使用equals判断
     */
    ...
    /**
     * 转换ArrayList为Object数组，返回对象应保证安全，及修改返回数组不影响原ArrayList
     */
